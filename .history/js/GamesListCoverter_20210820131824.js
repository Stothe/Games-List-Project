...
const filterSet = [["control"]["controlFilter"], ["players"]["nplayerFilter"]];
let nplayerArray = [];
let games = [];
...
function buildTXTList(){
  // const controlArray = filterControls(".control"); // gets filter data move this into universal if statement
  console.log(controlArray);
    ...
    for (const property in games[i]){
      ...
      if(filterSet.indexOf(property) > -1 ){
