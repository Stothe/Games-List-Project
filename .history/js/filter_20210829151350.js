...
function filterControls(){
    ...
    const enableNumButtons = document.getElementById("enableNumButtons");
    console.log(enableNumButtons.checked);
    if(enableNumButtons.checked){
        const maxButtons = document.getElementById("numButtons");
        games2 = games2.filter(game => game.buttons <= maxButtons.value);
    }
   
    //console.log(games2);   
    $('.stat').text(games2.length + " matches processed "); //updates DOM
